...
/**
 * The Farm class holds information of what the user currently owns, the status boosts they have, 
 * their Farmer character and their type of farm.
 * 
...
public class Farm {
	...
	/** 
	 * The constructor has a switch determined by the FarmType selected. 
	 ...
	 * @param farmer 	an object of the class Farmer. Should only be one.
	 */
	public Farm(String farmName, FarmType farmType, Farmer farmer) {
		...
		ArrayList<Crop> m_crops = new ArrayList<Crop>();
	...
	/**
	 * 
	 * @return name	the name of the farm.
	 */
	...
	/**
	 * 
	 * @param name	the name the player typed in for the farm.
	 */
	...
	/**
	 * 
	 * @return m_money the player's current cash balance.
	 */
	public int getMoney() {
		return m_money;
	}
	...
	/**
	 * 
	 * @param m_maxCrop sets the maximum amount of crops in farm.
	 */
	...
	/**
	 * 
	 * @param maxAnimal sets the maximum amount of animals in farm.
	 */
	...
	/**
	 * 
	 * @return m_cropCashMod the bonus cash player receives when harvesting crops. 
	...
	/**
	 * 
	 * @param m_cropCashMod sets the bonus money 
	 * 						percentage player earns to a different value. 
	 */
	...
	/**
	 * 
	 * @return m_animalHappinessMod influences owned animals' happiness level.
	 */
	...
	/**
	 * 
	 * @return m_purchaseDiscountMod A percentages Discount off of prices when buying
	 * 								 at GeneralStore.
	 */
	...
	/**
	 * 
	 * @param purchaseDiscount sets the how large a percentage of a discount player will receive
	 * 							
	 */

...
public class CartPanel extends JPanel {
	...
	public CartPanel(ArrayList<Merchandise> cart) {
		...
		gbc_hGlueLeft.insets = new Insets(0, 0, 5, 5);
		gbc_hGlueLeft.gridx = 0;
		gbc_hGlueLeft.gridy = 0;

		gbc_hGlueLeft.anchor = GridBagConstraints.NORTH;
		...
		gbc_lblProductHeader.insets = new Insets(0, 0, 5, 5);
		...
		gbc_hStrutProductAmt.insets = new Insets(0, 0, 5, 5);
		...
		gbc_lblAmountHeader.insets = new Insets(0, 0, 5, 5);
		...
		gbc_hStrutAmtPrice.insets = new Insets(0, 0, 5, 5);
		...
		gbc_hGlueRight.insets = new Insets(0, 0, 5, 0);
	...
	private void populateCart()
	{
		...
		{
			boolean found = false;
			for(Merchandise c : compactedList)
			{
		...
		for(int i = 0; i < compactedList.size(); i++)
		{
			...
			gbc_hGlueLeft.weighty = Double.MIN_VALUE;
			add(hGlueLeft, gbc_hGlueLeft);
